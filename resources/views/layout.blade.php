                ...
                <div class="carousel-inner" role="listbox">
                    @foreach( $sliders as $slider )
                        <div class="item {{ $loop->first ? ' active' : '' }}" >
                            <img src="{{ asset('uploads/slider/'.$slider->image) }}"  style=" width: 100%; height: 400px;" ">
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-8">
                                        <img src="{{ asset('uploads/slider/'.$slider->image) }}" class="girl img-responsive" alt="" />
                                    </div>
                                </div> 
                                @endforeach                       
                            </div>
                            ...
                            <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="{{ route('category.product',$category->id) }}">{{ $category->name }} 
                                            <span class="pull-right">({{ $category->products->count() }})</span></a>
                                        </h4>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="brands_products"><!--brands_products-->
                                ...
                                <div class="brands-name">
                                    ...
                                    <ul class="nav nav-pills nav-stacked">
                                        <li><a href="{{route('brand.product',$brand->id) }}">{{ $brand->name }} 

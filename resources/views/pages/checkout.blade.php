							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.html">Product Details</a></li>	<li><a href="{{ route('check.login') }}">Checkout</a></li>
				...
				<div class="row">
					<div class="col-sm-12 clearfix">
						<div class="bill-to">
							...
							<div class="form-one">
								<form action="{{ route('save.shipping.details') }}" method="post" style="margin-right: -342px;">
									@csrf
									...
									<input type="submit" value="Done" class="btn btn-sm btn-primary">
								</form>
							</div>							
						</div>
					</div>										

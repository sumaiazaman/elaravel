							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
									<ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.html">Product Details</a></li><li><a href="{{ route('show.cart') }}">Cart</a></li>
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{ asset('uploads/product/'.$content->options->image) }}" style="width: 70px; height: 70px;" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">{{ $content->name }}</a></h4>
								<p>Product ID: PC-{{ $content->id }}</p>
							</td>
							<td class="cart_price">
								<p>{{ $content->price }}</p>
							</td>
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<form action="{{ route('update.cart') }}" method="post">
										...
										<input type="submit" style="margin-top: 0px; margin-left: 4px;" name="submit" value="update" class="btn btn-sm btn-primary">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li>Shipping Cost <span>0.0</span></li>
